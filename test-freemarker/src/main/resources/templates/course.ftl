...
<div class="article-banner">
    ...
    <div class="banner-info">
        <div class="banner-left">
            ...
            <p class="info">
                <a href="http://ucenter.xuecheng.com/#/learning/${id!""}/0"  target="_blank" v-if="learnstatus == 1" v-cloak>马上学习</a>
		...
		高级
                ...
                <span><em>授课模式</em>
                  <#if studymodel=='201001'>
		自由学习
                <#elseif studymodel=='201002'>
		任务式学习
		</#if>
                </span>
            </p>
